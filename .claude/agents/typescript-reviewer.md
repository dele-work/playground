...
> When the diff contains `.tsx`/`.jsx` files, also apply the React checks below
> (hooks rules, `dangerouslySetInnerHTML`, RSC boundaries, render performance).
...
For this repository's TypeScript/JavaScript conventions and patterns, see
`.claude/rules/typescript.md` and `.claude/rules/coding-style.md`.
