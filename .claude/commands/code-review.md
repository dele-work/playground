...
2. **Planning artifacts** — Check `.claude/prds/`, `.claude/plans/`, and `.claude/reviews/` for context related to this PR
...
Create a review artifact at `.claude/reviews/pr-<NUMBER>-review.md`:
